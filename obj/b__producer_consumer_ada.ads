...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_producer_consumer_ada" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#7d099bea#;
   pragma Export (C, u00001, "producer_consumer_adaB");
